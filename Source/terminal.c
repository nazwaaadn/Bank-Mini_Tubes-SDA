...
{
    // Inisialisasi ke NULL semua dulu (anti sampah)
    ...
    X[1].info = "SimpangDago";  X[1].ps_fs = 2; X[1].ps_nb = 9;  X[1].ps_pr = 0;
    X[2].info = "Ciumbuleuit";   X[2].ps_fs = 3; X[2].ps_nb = 5;   X[2].ps_pr = 1;
    X[3].info = "Punclut";       X[3].ps_fs = 4; X[3].ps_nb = nil; X[3].ps_pr = 2;
    X[4].info = "Lembang";       X[4].ps_fs = nil; X[4].ps_nb = nil; X[4].ps_pr = 3;
    X[5].info = "Setiabudi";     X[5].ps_fs = 6;  X[5].ps_nb = nil; X[5].ps_pr = 2;
    X[6].info = "Ledeng";        X[6].ps_fs = 7;  X[6].ps_nb = nil; X[6].ps_pr = 5;
    X[7].info = "Parongpong";    X[7].ps_fs = 8;  X[7].ps_nb = nil; X[7].ps_pr = 6;
    X[8].info = "Lembang";       X[8].ps_fs = nil; X[8].ps_nb = nil; X[8].ps_pr = 7;

    X[9].info = "Pasteur";       X[9].ps_fs = 10; X[9].ps_nb = 17;  X[9].ps_pr = 1;
    ...
    X[14].info = "CimahiTengah";X[14].ps_fs = 15; X[14].ps_nb = nil; X[14].ps_pr = 13;
    X[15].info = "CimahiUtara"; X[15].ps_fs = 16; X[15].ps_nb = nil; X[15].ps_pr = 14;
    X[16].info = "KBP";          X[16].ps_fs = nil; X[16].ps_nb = nil; X[16].ps_pr = 15;

    X[17].info = "Gasibu";       X[17].ps_fs = 18; X[17].ps_nb = nil; X[17].ps_pr = 9;
    X[18].info = "CibeunyingKaler"; X[18].ps_fs = 19; X[18].ps_nb = nil; X[18].ps_pr = 17;
    X[19].info = "Antapani";     X[19].ps_fs = 20; X[19].ps_nb = nil; X[19].ps_pr = 18;
    X[20].info = "UjungBerung"; X[20].ps_fs = 21; X[20].ps_nb = nil; X[20].ps_pr = 19;
